...
extent={{-10,-10},{10,10}})));
  Modelica.Blocks.Interfaces.RealInput Set_T_Env 
    annotation (Placement(transformation(origin={-264,134},
extent={{-20,-20},{20,20}})));
  Modelica.Blocks.Interfaces.RealInput Set_R_Load 
    annotation (Placement(transformation(origin={-264,-68},
extent={{-20,-20},{20,20}})));
...
color={0,0,127}));
  connect(Set_T_Env, from_degC.u) 
  annotation(Line(origin={-256,132},
points={{-8,2},{39,2}},
color={0,0,127}),__MWORKS(BlockSystem(NamedSignal)));
  connect(limiter.u, Set_R_Load) 
  annotation(Line(origin={-240,-68},
  points={{23,0},{-24,0}},
  color={0,0,127}));
